...
program
    .command('backup')
    .description('want to make your life eternal ?... backup your stories to Google Drive.')
    .action(function(){
        forgotpw();
    });
...
program
    .command('erase')
    .description('did you make a mistake??? use erase to remove your most recent diary entry')
    .action(function(){
